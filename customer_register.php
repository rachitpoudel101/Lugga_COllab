...
function check_pass() {
    ...
    if (val != "") {
        ...
        // If the password length is greater than 6 and contains any lowercase alphabet, number, or special character
        if (val.length > 6 && (val.match(/[a-z]/) || val.match(/\d+/) || val.match(/.[!,@,#,$,%,^,&,*,?,_,~,-,(,)]/))) no = 2;

        // If the password length is greater than 6 and contains alphabet, number, and special character respectively
